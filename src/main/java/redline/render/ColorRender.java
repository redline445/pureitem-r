...
public class ColorRender extends Render {
    private static final String __OBFID = "CL_00001011";

    public void doRender(ColorLightning p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_)
    {
        ...
        for (int k1 = 0; k1 < 4; ++k1)
        {
            ...
            for (int j = 0; j < 3; ++j)
            {
                ...
                for (int i1 = k; i1 >= l; --i1)
                {
                    ...
                    tessellator.setColorRGBA_F(color.nextFloat(), color.nextFloat(), color.nextFloat(), 0.4F);
    ...
    protected ResourceLocation getEntityTexture(ColorLightning p_110775_1_)
    {
        return null;
    }
    ...
    {
        return this.getEntityTexture((ColorLightning)p_110775_1_);
    }

    public void doRender(Entity p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_)
    {
        this.doRender((ColorLightning)p_76986_1_, p_76986_2_, p_76986_4_, p_76986_6_, p_76986_8_, p_76986_9_);
    }
}
