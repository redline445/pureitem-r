...
import java.util.concurrent.FutureTask;
    ...
    public class Minecraft implements IPlayerUsage {
         ...
         */
        private static net.minecraft.client.Minecraft theMinecraft;
        ...
        public ByteBuffer func_152340_a(InputStream p_152340_1_) throws IOException {
        ...
        public void displayDebugInfo(long p_71366_1_) {
            if (this.mcProfiler.profilingEnabled) {
                List list = this.mcProfiler.getProfilingData(this.debugProfilerName);
                Profiler.Result result = (Profiler.Result) list.remove(0);
